...
function App() { 
  ...
  // State to hold the search term for filtering todos
    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        ...
        <input 
          ...
          className='w-full rounded-full px-5 py-1 mb-4'
        />
        ...
        <div className="todos">
          {/* Display message if no todos to display */}
          {filteredTodos.length === 0 && <div className='m-5'>No Todos to display</div>}
          
          {/* Render todos based on the search term */}
